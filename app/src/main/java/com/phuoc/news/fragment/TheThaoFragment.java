...
public class TheThaoFragment extends Fragment {
    ...
    RecyclerView recycle_view_bong_da;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recycle_view_bong_da = view.findViewById(R.id.recycle_view_bong_da);


        new ReadRSS().execute("https://cdn.24h.com.vn/upload/rss/bongda.rss");
        ...
        recycle_view_bong_da.setAdapter(itemDetailAdapter);
        recycle_view_bong_da.setLayoutManager(new LinearLayoutManager(getContext()));
