...
public class SucKhoeFragment extends Fragment {
    ...
    RecyclerView recycle_view_suc_khoe;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_suc_khoe, container, false);
        recycle_view_suc_khoe = view.findViewById(R.id.recycle_view_suc_khoe);
        ...
        new ReadRSS().execute("https://cdn.24h.com.vn/upload/rss/suckhoedoisong.rss");

        recycle_view_suc_khoe.setAdapter(itemDetailAdapter);
        recycle_view_suc_khoe.setLayoutManager(new LinearLayoutManager(getContext()));
        return view;
    }
