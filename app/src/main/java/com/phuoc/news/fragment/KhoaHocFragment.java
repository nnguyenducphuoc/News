...
public class KhoaHocFragment extends Fragment {
    ...
    RecyclerView recycle_view_khoa_hoc;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recycle_view_khoa_hoc = view.findViewById(R.id.recycle_view_khoa_hoc);
        ...
        new ReadRSS().execute("https://cdn.24h.com.vn/upload/rss/congnghethongtin.rss");

        recycle_view_khoa_hoc.setAdapter(itemDetailAdapter);
        recycle_view_khoa_hoc.setLayoutManager(new LinearLayoutManager(getContext()));
        return view;
    }
